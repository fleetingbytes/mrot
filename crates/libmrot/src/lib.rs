...
//!
//! A library for recording, planning and suggesting meals. It was created for the meal rotator app [mrot][mrot].
//!
...
/// Holds data about a date or a date range.
/// This is used when [removing](crate::Storage::remove)
/// or [renaming](crate::Storage::rename) records in the storage
/// or to avoid [suggesting](crate::Storage::what) certain meals.
#[derive(Debug, Clone)]
pub struct Period {
...
impl Period {
    ...
    /// Returns the [`NaiveDate`] of the first day of the period.
    pub fn first_date(&self) -> NaiveDate {
        self.first_date
    }

    /// Returns the timestamp of the first day of the period.
    pub fn first_day_timestamp(&self) -> i64 {
        self.first_day_timestamp
    }

    /// Return the [`NaiveDate`] of the last day of the period.
    pub fn last_date(&self) -> NaiveDate {
        self.last_date
    }

    /// Returns the timestamp of the last day of the period.
